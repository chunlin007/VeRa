...
static const STM32Capabilities stm32l43_12_xx = {

    .family = STM32_FAMILY_L4,
...
static const CortexMCoreCapabilities stm32l432_core = {
    .cpu_model = "cortex-m4",
    .has_mpu = true,
    //.has_itm = true, /* TODO: check */
    .has_etm = true,
    .num_irq = 61, /* TODO: check */
    .nvic_bits = 4, /**/
};
...
static const STM32PartInfo stm32_mcus[] = {
...
#endif
	{
        .name = TYPE_STM32F103C8Tx, /* STM32F103x[8B] */
        .cortexm = {
    ...
    },
    {
        ...
        .cortexm = {
            ...
            .sram_size_kb = 64,
			/* IDT_LIST*/
            .sram_base2 = 0xFFFFF7FF,
            .sram_size_kb2 = 2,

            .core = &stm32l432_core, /**/
        },
        .stm32 = &stm32l43_12_xx, /**/
    },
#if 0
    {
    ...
    },
    {
        ...
        .cortexm = {
            ...
            .sram_base = 0x20000000,
            .sram_size_kb = 64,
			// patch for XML_Parser
            .sram_base2 = 0x20010000,
            .sram_size_kb2 = 192,
            .core = &stm32f1xx_core, /**/
        },
        .stm32 = &stm32f105xx, /**/
