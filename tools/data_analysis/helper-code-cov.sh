...
#PATH_TO_FIRMWARE=$WORK_ROOT/DICE-advance/DICE-Evaluation/ARM/Fuzzing/Firmware/Binaries
PATH_TO_FIRMWARE=$WORK_ROOT/DICE-advance/DICE-Evaluation/ARM/Fuzzing/Firmware/Binaries-No-Ins
FIRMNAME=NRF52832_uart # replace this with the firmware name which will be tested
